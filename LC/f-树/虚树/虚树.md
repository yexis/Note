...
2. 整棵树上保留关键节点，保留任意两个关键节点之间的最近公共祖先
3. 虚树的根结点不一定是整棵树的根结点；有时会把整棵树的根节点额外加入虚树，让虚树多一个祖先节点，以此方便求解某些问题



虚树的使用场景：

1. 每个问题都涉及一批关键节点，但是所有问题的关键节点总量不大
...
1. 所有关键节点根据DFS序排序
2. 相邻的关键点的LCA加入序列，再排序
3. 序列中每一组相邻点（前后）    连边：LCA（前，后） --> 后
